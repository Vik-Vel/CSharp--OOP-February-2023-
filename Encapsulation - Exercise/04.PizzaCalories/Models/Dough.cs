...
namespace PizzaCalories.Models
{
    public class Dough
    {
        private const double doughCaloriesPerGram = 2.0;
        private readonly Dictionary<string, double> flourTypesCalories = new Dictionary<string, double>();
        private readonly Dictionary<string, double> bakingTechniquesCalories = new Dictionary<string, double>();
        ...
        public double Calories
        {
            get
            {
                ...
                return doughCaloriesPerGram * weight * flourTypeModifier * techniqueModifier;
            }
        }
