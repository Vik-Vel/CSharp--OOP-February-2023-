...
public class Tests_003_000
{
    ...
    [Test]
    public void ValidateRobotProperties()
    {
        var type = GetType("Robot");

        var properties = new[]
        {
            new Property(typeof(string), "Model", "Private"),
            new Property(typeof(int), "BatteryCapacity", "Private"),
            new Property(typeof(int), "BatteryLevel", "Private"),
            new Property(typeof(int), "ConvertionCapacityIndex", "Private"),
            new Property(typeof(IReadOnlyCollection<int>), "InterfaceStandards", "Private"),
        };
